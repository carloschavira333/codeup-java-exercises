...
public abstract class Quadrilateral extends Shape implements Measurable{
    ...
    //a constructor that accepts two numbers for the length and width and sets those properties.(Note: see Rectangle class for reference)
